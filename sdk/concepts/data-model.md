...
Verified against [v1.2.6 data models and protocols](https://github.com/MorscherLab/MINT/blob/v1.2.6/packages/sdk-python/src/mint_sdk/repositories.py) and [design ownership enforcement](https://github.com/MorscherLab/MINT/blob/v1.2.6/api/repositories/sql_experiment_repository.py).
