...
<div class="mint-component-reference__actions">
  ...
  <a class="mint-showcase-button mint-showcase-button--primary" href="https://github.com/MorscherLab/MINT/blob/v1.2.6/packages/sdk-frontend/src/components/BaseModal.vue">Source</a>
</div>
...
MINT SDK **1.2.6**. [Component source](https://github.com/MorscherLab/MINT/blob/v1.2.6/packages/sdk-frontend/src/components/BaseModal.vue).
...
| [` ModalVariant `](https://github.com/MorscherLab/MINT/blob/v1.2.6/packages/sdk-frontend/src/types/components.ts#L33) | ` 'centered' \| 'drawer' \| 'sheet' ` |
| [` ModalLayout `](https://github.com/MorscherLab/MINT/blob/v1.2.6/packages/sdk-frontend/src/types/components.ts#L34) | ` 'plain' \| 'tabs' \| 'rail' ` |
| [` ModalTab `](https://github.com/MorscherLab/MINT/blob/v1.2.6/packages/sdk-frontend/src/types/components.ts#L37) | See the linked SDK type definition. |
