...
<div class="mint-component-reference__actions">
  ...
  <a class="mint-showcase-button mint-showcase-button--primary" href="https://github.com/MorscherLab/MINT/blob/v1.2.6/packages/sdk-frontend/src/components/SettingsModal.vue">Source</a>
</div>
...
MINT SDK **1.2.6**. [Component source](https://github.com/MorscherLab/MINT/blob/v1.2.6/packages/sdk-frontend/src/components/SettingsModal.vue).
...
|---|---|
| [` SettingsTabInput `](https://github.com/MorscherLab/MINT/blob/v1.2.6/packages/sdk-frontend/src/types/components.ts#L489) | See the linked SDK type definition. |
| [` SettingsModalLayout `](https://github.com/MorscherLab/MINT/blob/v1.2.6/packages/sdk-frontend/src/types/components.ts#L491) | ` 'horizontal' \| 'vertical' ` |
| [` SettingsModalSchema `](https://github.com/MorscherLab/MINT/blob/v1.2.6/packages/sdk-frontend/src/types/components.ts#L516) | See the linked SDK type definition. |
...
| [` SettingsUserType `](https://github.com/MorscherLab/MINT/blob/v1.2.6/packages/sdk-frontend/src/types/components.ts#L520) | See the linked SDK type definition. |
