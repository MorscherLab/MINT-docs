...
<div class="mint-component-reference__actions">
  ...
  <a class="mint-showcase-button mint-showcase-button--primary" href="https://github.com/MorscherLab/MINT/blob/v1.2.1/packages/sdk-frontend/src/components/BioTemplateRenderer.vue">Source</a>
</div>
...
MINT SDK **1.2.1**. [Component source](https://github.com/MorscherLab/MINT/blob/v1.2.1/packages/sdk-frontend/src/components/BioTemplateRenderer.vue).
...
|---|---|
| [` BioTemplateEnvelope `](https://github.com/MorscherLab/MINT/blob/v1.2.1/packages/sdk-frontend/src/templates/types.ts#L40) | See the linked SDK type definition. |
| [` TemplateCollectionEnvelope `](https://github.com/MorscherLab/MINT/blob/v1.2.1/packages/sdk-frontend/src/templates/types.ts#L50) | See the linked SDK type definition. |
